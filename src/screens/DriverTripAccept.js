...
export default class DriverTripAccept extends React.Component {
   ...
   * 
   * @param {*} item 
   * Este metodo lo que hace es eliminar el booking de la persona que lo creo
      ...
      <View style={styles.mainViewStyle}>
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => {
            const parsedDate = Utils.parseDate(item.tripdate);
              ...
              <View style={styles.listItemView}>
                ...
                <View style={styles.mapDetails}>
                  <View style={styles.dateView}>
                    <Text style={styles.listDate}>{parsedDate}</Text>
                  </View>
